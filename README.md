...
- Add field `concurrency` to Transformer, which enables concurrency source remapping. It's value indicates the concurrency level. `0` means uses all available processors; -n means use all - n; default: `1`
